...
class Command(BaseCommand):
    ...
    def create_processes_with_steps(self, users, forms):
        ...
        if created:
            # Create a form for the employee evaluation process
            eval_form, eval_created = Form.objects.get_or_create(
                title='Employee Self Assessment',
                created_by=users[1],  # Same user as process
                defaults={
                    'description': 'Self-assessment form for employee evaluation',
                    'is_public': False,
                    'access_password': 'selfeval2024',
                    'is_active': True
                }
            )
            ...
            if eval_created:
                ...
                eval_fields_data = [
                    {
                        ...
                        'is_required': True,
                        'order_num': 1,
                        'options': {'choices': ['Exceeds Expectations', 'Meets Expectations', 'Below Expectations']}
                    },
                    {
                        'label': 'Strengths',
                        'field_type': 'text',
                ...
                for field_data in eval_fields_data:
                    Field.objects.create(form=eval_form, **field_data)
            ...
            steps_data = [
                ...
                {
                    'step_name': 'Detailed Self Review',
